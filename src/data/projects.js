...
export const projects = [
  // === ubermosh === / 2025
  {
    ...
    images: [
      "/my-portfolio/img/UBERMOSH/UBERMOSH-PREVIEW.png",
      "/my-portfolio/img/UBERMOSH/UBERMOSH-PREVIEW.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174631.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174654.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174714.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174754.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174915.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174849.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-10-26 174814.png",
      "/my-portfolio/img/UBERMOSH/Captura de pantalla 2025-f10-26 174714.png",
      "/my-portfolio/img/UBERMOSH/Vinillo3D.png",
      "/my-portfolio/img/UBERMOSH/Logo Ubermosh.webm",
    ],
    nextProject: {
      name: "Matcha No Kuma",
      url: "/my-portfolio/projects/matcha-no-kuma"
    },
    credits: {
      client: "Ubermosh",
      titleWebsite: "",
  ...
  // === runes-viking === / 2025
  {
    ...
    images: [
      "/my-portfolio/img/RUNES VIKING/RUNES VIKING-PREVIEW.png",
      "/my-portfolio/img/RUNES VIKING/RUNES VIKING-PREVIEW.png",
      "/my-portfolio/img/RUNES VIKING/Captura de pantalla 2025-10-27 205111.png",
      "/my-portfolio/img/RUNES VIKING/Captura de pantalla 2025-10-27 205047.png",
    ],
    nextProject: {
      name: "Ubermosh",
      url: "/my-portfolio/projects/ubermosh"
    },
    credits: {
      client: "Runes Viking",
  ...
  // === product-slider === / 2025
  {
    ...
    technologies: "HTML, CSS, JavaScript, GSAP",
    images: [
      "/my-portfolio/img/INFINITE SLIDER/INFINITE SLIDER-PREVIEW1.png",
      "/my-portfolio/img/INFINITE SLIDER/Captura de pantalla 2025-10-06 180152.png",
      "/my-portfolio/img/INFINITE SLIDER/INFINITE SLIDER-PREVIEW.png",
      "/my-portfolio/img/INFINITE SLIDER/Captura de pantalla 2025-10-06 181235.png",
    ],
    nextProject: {
      name: "Runes Viking",
      url: "/my-portfolio/projects/runes-viking"
    },
    credits: {
  ...
  // === matcha-no-kuma === / 2024
  {
    ...
    images: [
      "/my-portfolio/img/MATCHA NO KUMA/Matcha no kuma-PREVIEW3.png",
      "/my-portfolio/img/MATCHA NO KUMA/Matcha no kuma(HOME).jpg",
      "/my-portfolio/img/MATCHA NO KUMA/Matcha no kuma(ABOUT).png",
      "/my-portfolio/img/MATCHA NO KUMA/Matcha no kuma(MAP).png"
    ],
    nextProject: {
      name: "Gnotech",
      url: "/my-portfolio/projects/gnotech"
    },
    credits: {
  ...
  // === gnotech
  {
    ...
    images: [
      "/my-portfolio/img/GNOTECH/GNOTECH-PREVIEW2.png",
      "/my-portfolio/img/GNOTECH/GNOTECHHOME.jpg",
      "/my-portfolio/img/GNOTECH/Captura de pantalla 2025-10-27 200447.png",
      "/my-portfolio/img/GNOTECH/Captura de pantalla 2025-10-27 200349.png",
    ],
    nextProject: {
      name: "Signal",
      url: "/my-portfolio/projects/signal"
    },
    credits: {
      client: "Gnotech",
  ...
  // === signal
  {
    ...
    images: [
      "/my-portfolio/img/SIGNAL/Captura de pantalla 2025-01-27 221032.png",
      "/my-portfolio/img/SIGNAL/Captura de pantalla 2025-01-27 221127.png",
    ],
    nextProject: {
      name: "Neural Network",
      url: "/my-portfolio/projects/neural-network"
    },
    credits: {
      client: "Signal",
      titleWebsite: "",
  ...
  // === neural-network
  {
    ...
    technologies: "HTML, CSS, JavaScript",
    images: [
      "/my-portfolio/img/NEURAL NETWORK/NEURAL_NETWORK-PREVIEW2.png",
      "/my-portfolio/img/NEURAL NETWORK/NEURAL_NETWORK-PREVIEW.png"
    ],
    nextProject: {
      name: "Henka Jin",
      url: "/my-portfolio/projects/henka-jin"
    },
    credits: {
  ...
  // === henka-jin
  {
    ...
    images: [
      "/my-portfolio/img/HENKA JIN/HENKA_JIN-PREVIEW2.png",
      "/my-portfolio/img/HENKA JIN/OKINA KOI -- HOME.jpg",
      "/my-portfolio/img/HENKA JIN/OKINA KOI -- PRODUCT.png",
      "/my-portfolio/img/HENKA JIN/OKINA KOI -- CONTACTS.png",
    ],
    nextProject: {
      name: "Product Slider",
      url: "/my-portfolio/projects/product-slider",
    },
    credits: {
      client: "Henka Jin",
...
export const projects3D = [
  { src: "/my-portfolio/img/3D GALLERY LOW/Desert_1.jpg", alt: "Desert 1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Desert_1.jpg", alt: "Desert 1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Desert_2.jpg", alt: "Desert 2" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Desert_3.jpg", alt: "Desert 3" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Desert_4.jpg", alt: "Desert 4" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Seaside_1.jpg", alt: "Seaside 1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.I.I NEW.jpg", alt: "X.I.I NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.V.I NEW.jpg", alt: "X.V.I NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.I.X NEW.jpg", alt: "X.I.X NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.I.V NEW.jpg", alt: "X.I.V NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.V NEW.jpg", alt: "X.V NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.V.I.I NEW.jpg", alt: "X.V.I.I NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.I.I.I NEW.jpg", alt: "X.I.I.I NEW" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.X Nitido.jpg", alt: "X.X Nitido" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.X.I CameraMoving.jpg", alt: "X.X.I CameraMoving" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.X.I CameraMoving.jpg", alt: "X.X.I CameraMoving" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.X.I CameraMovingComparation.jpg", alt: "X.X.I CameraMovingComparation" },
  { src: "/my-portfolio/img/3D GALLERY LOW/X.X.I CameraMovingOutlast.jpg", alt: "X.X.I CameraMovingOutlast" },

  { src: "/my-portfolio/img/3D GALLERY LOW/ETERNITY_V1.1.jpg", alt: "ETERNITY_V1.1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/ETERNITY_V2.1.jpg", alt: "ETERNITY_V2.1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/ETERNITY_V3.1.jpg", alt: "ETERNITY_V3.1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/ETERNITY_V4.1.jpg", alt: "ETERNITY_V4.1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/ETERNITY_V1.1.jpg", alt: "ETERNITY_V1.1 Duplicate" },

  { src: "/my-portfolio/img/3D GALLERY LOW/咒語_1.jpg", alt: "咒語_1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/咒語_BHUDDA_1.1.jpg", alt: "咒語_BHUDDA_1.1" },

  { src: "/my-portfolio/img/3D GALLERY LOW/Weapon_1.png", alt: "Weapon 1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Weapon_2.png", alt: "Weapon 2" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Weapon_3.png", alt: "Weapon 3" },

  { src: "/my-portfolio/img/3D GALLERY LOW/untitled5.jpg", alt: "untitled5" },
  { src: "/my-portfolio/img/3D GALLERY LOW/TV_1.jpg", alt: "TV_1" },

  { src: "/my-portfolio/img/3D GALLERY LOW/tierra_1.jpg", alt: "tierra_1" },
  ...
  { src: "/my-portfolio/img/3D GALLERY LOW/TV_1.jpg", alt: "TV_1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/tierra_1.jpg", alt: "tierra_1" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Tierra_2.jpg", alt: "Tierra_2" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Tierra_3.jpg", alt: "Tierra_3" },
  { src: "/my-portfolio/img/3D GALLERY LOW/Tierra_4.jpg", alt: "Tierra_4" },
